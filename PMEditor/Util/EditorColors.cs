...
namespace PMEditor.Util
{
    public class EditorColors
    {
        ...
        public readonly static Color catchColorButNotOnThisLine = Color.FromArgb(128, 201, 190, 67);
        ...
        public readonly static Color functionColorButNotOnThisLine = Color.FromArgb(128, 255, 119, 10);
